...
void showcase_run_frameControls(Plotypus::Report& report)
{
    ...
    report.setCustomScriptBegin("# put here gnuplot code that should be executed right after terminal setup");
    report.setCustomScriptEnd  ("# put here gnuplot code that should be executed after the last sheet is written");

    sheet1
    .setCustomScriptBegin("# put here gnuplot code that should be executed before the page setup")
    .setCustomScriptInter("# put here gnuplot code that should be executed between page setup and plot commands")
    .setCustomScriptEnd  ("# put here gnuplot code that should be executed BEFORE the tidy up code generated by Plotypus but AFTER the plots");
}
