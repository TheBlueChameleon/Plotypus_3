...
namespace Plotypus
{
    ...
    size_t& DataView::columnAssignment(const ColumnType columnType)
    {
    ...
    std::string& DataView::columnFormat(const ColumnType columnType)
    {
    ...
    std::string& DataView::columnHeadline(const ColumnType columnType)
    {
